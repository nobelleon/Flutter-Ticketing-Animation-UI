...
import 'package:ticketing_ui/src/const/constants.dart';
import 'package:ticketing_ui/src/pages/beranda.dart';
import 'package:ticketing_ui/src/pages/ticket_page.dart';
import 'package:ticketing_ui/src/pages/ticket_page1.dart';
import 'package:ticketing_ui/src/pages/ticket_page2.dart';
import 'package:ticketing_ui/src/pages/ticket_page3.dart';
import 'package:ticketing_ui/src/pages/ticket_page4.dart';
import 'package:ticketing_ui/src/widgets/fade_transition.dart';
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: AvatarCircle(
                        link:
                            'https://images.pexels.com/photos/3101520/pexels-photo-3101520.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
                        onTap: () {
                          _fadeOutTransition.forward().then(
                                (value) => Navigator.of(context).push(
                                  PageRouteBuilder(
                    ...
                    Positioned(
                      ...
                      child: AvatarCircle(
                        link:
                            'https://images.pexels.com/photos/3984828/pexels-photo-3984828.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
                        onTap: () {
                          _fadeOutTransition.forward().then(
                                (value) => Navigator.of(context).push(
                                  PageRouteBuilder(
                    ...
                    Positioned(
                      ...
                      child: AvatarCircle(
                        link:
                            'https://images.pexels.com/photos/8512685/pexels-photo-8512685.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load',
                        onTap: () {
                          _fadeOutTransition.forward().then(
                                (value) => Navigator.of(context).push(
                                  PageRouteBuilder(
                    ...
                    Positioned(
                      ...
                      child: AvatarCircle(
                        link:
                            'https://images.pexels.com/photos/7097458/pexels-photo-7097458.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
                        onTap: () {
                          _fadeOutTransition.forward().then(
                                (value) => Navigator.of(context).push(
                                  PageRouteBuilder(
