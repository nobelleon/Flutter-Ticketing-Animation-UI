...
class TicketPage4 extends StatefulWidget {
  ...
  const TicketPage4({super.key, required this.fadeOutTransition});

  @override
  State<TicketPage4> createState() => _TicketPage4State();
}
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                fit: BoxFit.cover,
                image: NetworkImage(
                  'https://images.pexels.com/photos/5192291/pexels-photo-5192291.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
                ),
              ),
            ),
          ),
